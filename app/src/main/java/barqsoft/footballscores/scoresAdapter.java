    ...
    public void bindView(View view, final Context context, Cursor cursor)
    {
        ...
        if (homeGoals < 0) {
            contentDescription = String.format(Locale.getDefault(),
                    context.getString(R.string.match_not_played),
                    homeName, awayName);
        } else {
            contentDescription = String.format(Locale.getDefault(),
                    context.getString(R.string.score_content_description),
                    homeGoals, awayGoals, homeName, awayName);
        }
        mHolder.score_card.setContentDescription(contentDescription);
        ...
        mHolder.home_crest.setImageResource(Utilies.getTeamCrestByTeamName(homeName));
        mHolder.away_crest.setImageResource(Utilies.getTeamCrestByTeamName(awayName));
